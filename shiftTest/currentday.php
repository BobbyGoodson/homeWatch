<html>
	<head>
		...
		<style>
			table { border-collapse:collapse; font-family:verdana, arial, sans-serif; 
				background: white; width: 65%; margin-left: auto; margin-right: auto; }
			td { border: 1px solid black; font-size:24px; padding:10px; }
			thead {background-color: #6A1A41; }
			th { border: 1px solid black; font-size:24px; padding:10px; color: white; }
		</style>
	</head>
	<body>
		<?php
